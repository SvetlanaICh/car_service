namespace CarService.Model.Entities
{
	...
	public partial class CarServiceContextTrial : DbContext, ICarServiceContext
	{
		/*static CarServiceContextTrial()
		{
			Database.SetInitializer<CarServiceContextTrial>(new CarServiceTrialInitializer());
		}*/

		public CarServiceContextTrial()
			: base("name=CarServiceContextTrial")
		{
		}
