...
{
	public delegate void DelegateSearch(ref IQueryable<OrderExtended> aResult, string aValue);
	public delegate void DelegateSort(ref IQueryable<OrderExtended> aResult, bool aIsAscending);

	public class DataHandler_3 : IDataHandler
	{
